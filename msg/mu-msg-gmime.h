...
#include "msg/mu-msg-gmime-init.h"
#include "mu/mu-msg.h"
...
/** 
 * get the References: header of this message
 *
 * @param a valid MuMsgGMime* instance
 * 
 * @return the References: of this Message or NULL in case of error or if there 
 * are none. the returned string should *not* be modified or freed.
 */
const char*     mu_msg_gmime_get_refs            (MuMsgGMime *msg);

/** 
 * get the User-Agent (the e-mail program) of this message. Both the X-Mailer
 * and User-Agent are inspected, with preference for the latter
 *
 * @param a valid MuMsgGMime* instance
 * 
 * @return the User-Agent of this Message or NULL in case of error or if there 
 * is none. the returned string should *not* be modified or freed.
 */
const char*     mu_msg_gmime_get_user_agent      (MuMsgGMime *msg);


/** 
 * get the Mailing List Id where this message was sent to (the List-Id: header)
 *
 * @param a valid MuMsgGMime* instance
 * 
 * @return the Mailing list Id of this Message or NULL in case of error or 
 * if there is none. the returned string should *not* be modified or freed.
 */
const char*     mu_msg_gmime_get_mailing_list    (MuMsgGMime *msg);
 ...
 * @return the filesize 
 */
size_t          mu_msg_gmime_get_file_size       (MuMsgGMime *msg);
