...
test_msg_str_flags (void)
{
	...
	g_assert_cmpstr (mu_msg_str_flags_s
			 (MU_MSG_FLAG_FLAGGED|MU_MSG_FLAG_PASSED|
...
main (int argc, char *argv[])
{
	...
	g_test_add_func ("/find/test-display-str-size", test_msg_str_size);
	g_test_add_func ("/find/test-display-str-flags", test_msg_str_flags);
